...
class AppColors {
  ...
  static const Color laranjaAlerta = Color(0xFFFF6B35);
  static const Color laranjaAlertaesWEs = Color(0xFFFF6B35); // Fix para typo

  // Cores de Interface
  static const Color fundoCartao = Color(0xFFF8F9FA);
  static const Color fundoSecundario = Color(0xFFE9ECEF);
  static const Color textoEscuro = Color(0xFF212529);
...
// ===== CORES CONTEXTUAIS PARA HEADERS =====
  ...
  static const Color verdeHeader = Color(0xFF006400);      // Receitas

  // Cores de fundo para tabs
  static const Color vermelhoFundo = Color(0xFFFFF5F5);   // Fundo despesas
  static const Color verdeFundo = Color(0xFFF5FFF5);      // Fundo receitas
  ...
  // Cores Neutras - 70% Transparência
  static const Color brancoTransparente70 = Color(0xB3FFFFFF);
  static const Color cinzaClaroTransparente70 = Color(0xB3F5F7FA);
  static const Color cinzaMedioTransparente70 = Color(0xB36C757D);
  static const Color cinzaEscuroTransparente70 = Color(0xB3333333);
  static const Color cinzaTextoTransparente70 = Color(0xB3666666);
  static const Color cinzaLegendaTransparente70 = Color(0xB3999999);
  static const Color cinzaBordaTransparente70 = Color(0xB3E0E0E0);
